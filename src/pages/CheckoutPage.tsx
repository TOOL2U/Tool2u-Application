...
import { CreditCard, Calendar, Lock, MapPin, Loader2, ArrowLeft, Wallet, Building2, QrCode, AlertCircle, Navigation } from 'lucide-react';
...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    if (showMap && mapLoaded && mapRef.current && window.google) {
      // Initialize the map
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute right-2 top-1/2 -translate-y-1/2 flex gap-2">
                      <button
                        ...
                        type="button"
                        className="bg-[#FFD700] text-gray-900 px-3 py-1 rounded-md text-sm font-medium hover:bg-[#FFE44D] transition-colors flex items-center gap-2"
                        disabled={isLocating}
                      >
                        {isLocating ? (
                          <>
                      ...
                      <button
                        ...
                        type="button"
                        className="bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-sm font-medium hover:bg-gray-200 transition-colors flex items-center gap-2"
                      >
