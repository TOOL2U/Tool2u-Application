...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <div className="border-b border-gray-200 py-4">
      <button
        className="flex justify-between items-center w-full text-left btn-animate"
...
function FeatureCard({ icon: Icon, title, description }: { icon: any, title: string, description: string }) {
  return (
    <div className="p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-250 hover:translate-y-[-5px] transform transition-transform">
    ...
    <>
        ...
        <div className="relative z-20 min-h-screen flex items-center">
          <div className="container mx-auto px-6 py-24">
            <div className="max-w-3xl">
              <h1 className="text-5xl md:text-6xl font-bold mb-6 animate-fadeIn" style={{ animationDuration: '500ms' }}>
                Professional Tools,
                <br />
                <span className="text-[#FFD700]">Delivered to Your Door</span>
              </h1>
              <p className="text-xl mb-8 opacity-90 animate-fadeIn" style={{ animationDuration: '500ms', animationDelay: '200ms' }}>
                Get the right tools when you need them. Fast delivery, professional-grade equipment, and hassle-free returns.
              </p>
              <div className="flex flex-wrap gap-4 animate-fadeIn" style={{ animationDuration: '500ms', animationDelay: '400ms' }}>
                <Button
                  to="/categories"
                  variant="primary"
                  size="lg"
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          ...
          <StaggeredList className="grid md:grid-cols-3 gap-8 text-left mt-12">
            <div className="text-center">
              <Wrench className="w-12 h-12 text-[#FFD700] mx-auto mb-4" />
